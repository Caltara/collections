...
def send_sms(to, name, amount, due_date):
    message = f"Hi {name}, this is a friendly reminder from Furry Friends. You have an unpaid invoice of ${amount} due on {due_date}. Please reply or call to arrange payment."
